  ...
  return (
    <section className="border-t border-line py-14">
      <div className="mx-auto max-w-7xl px-6">
        <p className="mb-9 text-center font-mono text-xs uppercase tracking-[0.2em] text-slate-500">
          ...
          {items.map((inst) => (
            ...
            >
              <img
                src={inst.logo_url}
                alt={inst.nombre}
                className="h-8 w-auto opacity-50 brightness-0 invert transition-all duration-300 group-hover:scale-110 group-hover:opacity-100"
              />
            </a>
          ))}
        </div>
