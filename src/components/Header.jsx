    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="#inicio" className="flex items-center gap-2.5">
          ...
          <span className="font-display text-base font-700 leading-none tracking-tight text-white">
            Red IA<span className="text-primary-400"> · Equidad</span>
          </span>
        </a>
          ...
          {NAV.map((item) => (
            <a
              ...
              className={`text-sm font-500 transition-colors ${
                active === item.href ? 'text-primary-400' : 'text-slate-400 hover:text-white'
              }`}
            >
              {item.label}
            </a>
        ...
        <a
          href="#contacto"
          className="hidden rounded-xl bg-primary-400 px-5 py-2.5 text-sm font-600 text-base transition-all duration-300 hover:bg-primary-300 lg:inline-block"
        >
          Súmate a la Red
        </a>
      ...
      <div
        className={`overflow-hidden border-t border-line bg-base/95 backdrop-blur-md transition-all duration-300 lg:hidden ${
